...
// =================================================================================================
/*
// by default ExtendedMovieClip will discard all Animations on dispose().
// sample usage, with unique animation instances for each movie clip instance:
var movieClip:ExtendedMovieClip = new ExtendedMovieClip(); // will dispose of Animations on dispose()
movieClip.addAnimation("anim_name_here", cGlobals.TextureAtlas1.getTextures("frames_here_"), 30);
movieClip.play("anim_name_here");
// or could do this instead:
// movieClip.setCurrentAnimation("anim_name_here"); // then call play and stop whenever you want
Starling.juggler.add(movieClip);

// sample usage, with shared animation instances:
var animations:Dictionary = new Dictionary();
animations["anim_name"] = new Animation(cGlobals.TextureAtlas1.getTextures("anim_name_"), 30);
animations["anim_name2"] = new Animation(cGlobals.TextureAtlas1.getTextures("anim_name2_"), 30);

var movieClip2:ExtendedMovieClip = new ExtendedMovieClip(false); // won't dispose Animation instances during dispose()
movieClip2.addAnimationReference("anim_name", animations["anim_name"]);
movieClip2.addAnimationReference("anim_name2", animations["anim_name2"]);
movieClip2.play("anim_name_here");
// or could do this instead:
// movieClip2.setCurrentAnimation("anim_name_here"); // then call play and stop whenever you want
Starling.juggler.add(movieClip2);
