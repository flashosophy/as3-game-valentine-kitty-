package com.vitapoly.features.statemachine
{
	import flash.events.*;
	...
	public class StateMachine extends EventDispatcher
	{
		...
		**/
		public function changeState(stateTo:String, obj:*=null):void
		{
			...
			//	trace("[StateMachine]",id,"Transition to "+ stateTo +" from "+ _state +" denied");
